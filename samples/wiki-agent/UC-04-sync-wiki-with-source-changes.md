...
- **Primary actor:** User
- **Supporting actors:** [Orchestrator](ACTOR-CATALOG.md#orchestrator) (`/refresh-wiki` command), [Fact-checker agents](ACTOR-CATALOG.md#fact-checker-agents), [Writer agents](ACTOR-CATALOG.md#fixer-agents-corrector) (wiki-writer, shared with UC-03)
